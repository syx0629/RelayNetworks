...
class DartEnv(gym.Env):
    ...
    def __init__(self, model_paths, frame_skip, observation_size, action_bounds, \
        ...
        #self.InitState = gym.Env.InitState
        self.viewer = None
    ...
    def render(self, mode='human', close=False):
        if not self.disableViewer:
            self._get_viewer().scene.tb.trans[0] = -self.dart_world.skeletons[self.track_skeleton_id].com()[0]*0
        if close:
